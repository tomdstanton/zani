...
git remote add origin git@github.com:tomdstanton/zani.git
...
- Add the API Token to your projects secrets with the name `PYPI_TOKEN` by visiting [this page](https://github.com/tomdstanton/zani/settings/secrets/actions/new).
- Create a [new release](https://github.com/tomdstanton/zani/releases/new) on Github.
